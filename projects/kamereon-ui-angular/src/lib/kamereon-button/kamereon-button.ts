...
import { KamereonIcon } from '../kamereon-icon/kamereon-icon';
import { KamereonIconType } from '../types/KamereonIcon';
import { Size } from '../types/size';
import { Variant } from '../types/variants';

@Component({
	selector: 'kamereon-button',
	imports: [KamereonIcon],
...
export class KamereonButton {
	...
	icon = input<KamereonIconType | null>(null);
